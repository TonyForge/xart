...
namespace ok
{
	namespace graphics
	{
		...
		public:
			...
			std::vector<glm::vec4> extra_data;
		};
		...
		{
		public:
			SpriteBatch(int size = 1000, int extra_data_channels = 0);
			~SpriteBatch();
		...
		private:
			...
			static std::vector<glm::vec4>* quad_extra_data;
			static ok::Quad quad;
			...
			static const unsigned int quad_extra_data_size = 4 * 4;//4 vertices, 4 floats of extra data per vertex
