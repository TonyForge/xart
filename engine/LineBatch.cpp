...
void ok::graphics::LineBatch::SetMaterial(ok::graphics::Material * material)
{
...
ok::Color ok::graphics::LineBatch::GetBrushColor()
{
	return brush_color_begin;
}

float ok::graphics::LineBatch::GetBrushThickness()
{
	return brush_thickness;
}

float ok::graphics::LineBatch::GetBrushSoftness()
{
